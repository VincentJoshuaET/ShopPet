...
class MainActivity : AppCompatActivity() {
    ...
    fun instanceId() {
        auth.getToken().observe(this) { result ->
    ...
    private fun showChatSnackbar(event: Chat.Event) {
        ...
        if (toolbar.title != senderUsername && destination.id != R.id.fragment_conversation && destination.id != R.id.fragment_chat) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataViewModel.cache.observe(this) { event ->
