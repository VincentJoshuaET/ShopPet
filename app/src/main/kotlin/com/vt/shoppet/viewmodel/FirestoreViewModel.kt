...
@HiltViewModel
class FirestoreViewModel @Inject constructor(private val firestore: FirestoreRepo) : ViewModel() {
    ...
    fun markChatAsRead(id: String, read: List<Boolean>) =
        viewModelScope.launch(Dispatchers.IO) {
            delay(3000)
            firestore.markChatAsRead(id, read)
        }
